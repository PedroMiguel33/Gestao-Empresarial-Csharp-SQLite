...
namespace CP
{
    public class CBLDropdownMenu : ContextMenuStrip
    {
        //Fields
        ...
        //Constructor
        public CBLDropdownMenu(IContainer container)
            : base(container)
        {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            {
                this.Renderer = new CBLMenuRenderer(isMainMenu, primaryColor, menuItemTextColor);
                LoadMenuItemHeight();
            }
        }
    }
