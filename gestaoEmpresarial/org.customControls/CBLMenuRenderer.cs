...
namespace CP
{
    public class CBLMenuRenderer : ToolStripProfessionalRenderer
    {
        //Fields
        ...
        //Constructor
        public CBLMenuRenderer(bool isMainMenu, Color primaryColor, Color textColor)
            : base(new CBLMenuColorTable(isMainMenu, primaryColor))
        {
